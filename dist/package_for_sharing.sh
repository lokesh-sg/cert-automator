...
docker buildx build --pull --no-cache --platform linux/amd64 -t cert-automator:amd64 --load ./prod
...
docker buildx build --pull --no-cache --platform linux/arm64 -t cert-automator:arm64 --load ./prod
