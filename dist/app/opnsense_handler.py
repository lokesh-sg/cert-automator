...
class OPNSenseHandler(CertificateHandler):
    def renew(self, cert_path: str, key_path: str) -> bool:
        ...
        try:
            ...
            resp = requests.post(add_url, json=data, auth=auth, verify=False, timeout=10)
    ...
    def cleanup_expired(self) -> dict:
        ...
        for cert in expired_certs:
            ...
            try:
                ...
                resp = requests.post(del_url, json={}, auth=auth, verify=False, timeout=10)
                if resp.status_code == 200:
                    res_json = resp.json()
    ...
    def _get_expired_certs(self):
        ...
        try:
            ...
            resp = requests.post(search_url, json=payload, auth=auth, verify=False, timeout=10)
            if resp.status_code != 200:
